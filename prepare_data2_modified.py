...
# python prepare_data2.py data/shakespeare/shakespeare_input.txt data2/shakespeare/out_data_150 ^\\s+[A-Za-z,;'\"\\s]+[.?!]$ -m 150
...
def parse_seq(example_proto):
    ...
    return tf.sparse_to_dense(sparse_seq.indices, sparse_seq.dense_shape,
                              sparse_seq.values)
